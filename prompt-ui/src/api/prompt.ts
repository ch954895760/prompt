...
export function getPrompts(params: { current?: number; size?: number; categoryId?: number; tagId?: number; keyword?: string; sortBy?: string }): Promise<{ records: Prompt[]; total: number }> {
